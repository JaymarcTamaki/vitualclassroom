...
if (isset($_GET['profile_username'])) {
    ...
    $privilage = $user_array['privilage'];
}
...
<main class="profile-body">
    ...
    <div class="modal">
        <form action=<?php echo $username; ?> method="POST">
            ...
            <input type="int" name="Privilage" id="" value=<?php echo $privilage; ?> autofocus autocomplete="off">
    ...
    <section class="profile">
        ...
        <span class="titles">Privilage:</span>
        <p>&nbsp;&nbsp; <?php echo $privilage; ?> </p>
